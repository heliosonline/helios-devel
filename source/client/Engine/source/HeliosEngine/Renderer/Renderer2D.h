...
namespace Helios {
	...
	public:
		...
		// Colored rotated quad with 2D position (rotation in radians)
		static void DrawRotatedQuad(const glm::vec2& position, const glm::vec2& size, float rotation, const glm::vec4& color);
		// Colored rotated quad with 3D position (rotation in radians)
		static void DrawRotatedQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const glm::vec4& color);
		// Textured rotated quad with 2D position (optional tiling, rotation in radians)
		...
		// Textured rotated quad with 2D position and color (rotation in radians)
		...
		// Textured rotated quad with 2D position, tiling and color (rotation in radians)
		...
		// Textured rotated quad with 3D position (optional tiling, rotation in radians)
		...
		// Textured rotated quad with 3D position and color (rotation in radians)
		...
		// Textured rotated quad with 3D position, tiling and color (rotation in radians)
